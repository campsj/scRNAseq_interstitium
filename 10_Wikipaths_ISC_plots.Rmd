...
## Import files
```{r}
go_isc1 = read.delim("tables/ISC/Wikipathways/WikiPathways_2016_table_ISC1.txt", header = TRUE)
go_isc2 = read.delim("tables/ISC/Wikipathways/WikiPathways_2016_table_ISC2.txt", header = TRUE)
go_isc3a = read.delim("tables/ISC/Wikipathways/WikiPathways_2016_table_ISC3a.txt", header = TRUE)
go_isc3b = read.delim("tables/ISC/Wikipathways/WikiPathways_2016_table_ISC3b.txt", header = TRUE)
go_isc3c = read.delim("tables/ISC/Wikipathways/WikiPathways_2016_table_ISC3c.txt", header = TRUE)
head(go_isc1)
```
...
```{r}
p[8, "Term"] <- "XPodNet - protein-protein interactions in the podocyte"
```
...
ggsave("plots/ISC/GO/Wikipaths.pdf", dpi = 600, width = 5, height = 6)
```
