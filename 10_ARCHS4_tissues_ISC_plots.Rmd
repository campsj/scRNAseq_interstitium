...
## Import files
```{r}
go_isc1 = read.delim("tables/ISC/ARCHS4/ARCHS4_Tissues_table_ISC1.txt", header = TRUE)
go_isc2 = read.delim("tables/ISC/ARCHS4/ARCHS4_Tissues_table_ISC2.txt", header = TRUE)
go_isc3a = read.delim("tables/ISC/ARCHS4/ARCHS4_Tissues_table_ISC3a.txt", header = TRUE)
go_isc3b = read.delim("tables/ISC/ARCHS4/ARCHS4_Tissues_table_ISC3b.txt", header = TRUE)
go_isc3c = read.delim("tables/ISC/ARCHS4/ARCHS4_Tissues_table_ISC3c.txt", header = TRUE)
head(go_isc1)
```
...
ggsave("plots/ISC/GO/ARCHS4.pdf", dpi = 600, width = 3.75, height = 6)
```
